...
from src.util.constant import COLUMN_FURNITURE_ID_TWO, ENDPOINT_APP, ENDPOINT_APP_FURNITURE, ENDPOINT_GENERIC_DELETE_BY_ID
...
async def delete_by_id(id: str):
    data = dict({COLUMN_FURNITURE_ID_TWO:id})
