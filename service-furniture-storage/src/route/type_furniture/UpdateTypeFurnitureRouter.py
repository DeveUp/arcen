...
from src.util.constant import COLUMN_TYPE_FURNITURE, COLUMN_TYPE_FURNITURE_ID_TWO, ENDPOINT_APP, ENDPOINT_APP_TYPE_FURNITURE, ENDPOINT_GENERIC_UPDATE
...
async def update(id: str, type_furniture: TypeFurnitureDto):
    data = dict({
        COLUMN_TYPE_FURNITURE_ID_TWO: id, 
