"""
    @name - DeleteByIdDependenceRouter
    @description - Punto de entrada servicio dependence operacion eliminar dependence por el pk
    @version - 1.0.0
...
# @Rest - Elimina un dependence por su pk
