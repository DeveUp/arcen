"""
    @name - UpdateDependenceRouter
    @description - Punto de entrada servicio dependence operacion actualizar un dependence por su pk
    @version - 1.0.0
...
# @Rest - Actualiza un dependence por su pk
