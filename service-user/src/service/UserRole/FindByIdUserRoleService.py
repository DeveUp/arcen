"""
    @name - FindByIdUserRoleService
    @description - Servicio para consultar un user role por su pk
    @version - 1.0.0
...
from src.persistence.repository.user_role.FindByIdUserRoleRepository import FindByIdUserRoleRepository as FindByEntity
from src.persistence.schema.UserRoleSchema import UserRoleSchema as SchemaEntity
...
class FindByIdUserRoleService(IService):
