"""
    @name - FindByIdTypeBoxService
    @description - Servicio para consultar un type box por su pk
    @version - 1.0.0
...
from src.persistence.repository.TypeBox.FindByIdTypeBoxRepository import FindByIdTypeBoxRepository as FindByEntity
...
class FindByIdTypeBoxService(IService):
