"""
    @name - UpdateTypeBoxService
    @description - Servicio para actualizar un type box por su pk
    @version - 1.0.0
...
class UpdateTypeBoxService(IService):
    ...
    # @override
    # @method - Actualizar un type box por su pk
    # @parameter - data - Json con el type box a actualizar
    # @return - TypeBox
