"""
    @name - UpdateSubObjectService
    @description - Servicio para actualizar un subobjeto por su pk
    @version - 1.0.0
...
from src.persistence.repository.subobject.UpdateSubObjectRepository import UpdateSubObjectRepository
...
class UpdateSubObjectService(IService):

    # @method - Constructor 
    # @return - Void
    def __init__(self, db: Session):
        self.repository = UpdateSubObjectRepository(db)
    ...
    # @parameter - data - Json con el subobjeto a actualizar
    # @return - SubObject
    def execute(self, data:dict):
        try:
            ...
            feign_audit_save_error(
                ...
                self.current_service,
                self.current_operation,
                RESPONSE['subobject']['put']['update']['error']['default']
            )
        feign_audit_save(
            self.feign_audit,
            self.current_service,
