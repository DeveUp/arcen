...
from src.util.constant import ENDPOINT_APP, ENDPOINT_APP_DOCUMENT, ENDPOINT_GENERIC_FIND_ALL
...
endpoint = ENDPOINT_APP+ENDPOINT_APP_DOCUMENT+ENDPOINT_GENERIC_FIND_ALL
