...
from src.util.constant import COLUMN_CONTROL_AUDIT_NAME, ENDPOINT_APP, ENDPOINT_APP_CONTROL_AUDIT_CLOSURE, ENDPOINT_GENERIC_FIND_BY_NAME
...
async def find_by_name(name:str):
    data = dict({COLUMN_CONTROL_AUDIT_NAME:name})
